...
export class popoverDirective {
  ...
  open() {
    ...
    var placement = this.popoverDirection == 'bottom' ? { top : this.position.top + this.position.height, left: this.position.left + this.position.width / 2 - popoverWidth / 2} :
      ...
      this.popoverDirection == 'left'? { top : this.position.top + this.position.height / 2 - popoverHeight / 2, left : this.position.left - popoverWidth} :
      { top : this.position.top + this.position.height / 2 - popoverHeight / 2, left : this.position.left + popoverWidth}
